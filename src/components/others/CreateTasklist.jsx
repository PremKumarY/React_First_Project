...
const CreateTasklist=()=>{
    return(
        ...
        <form className='flex flex-warp  w-full items-start   justify-between'>
            <div className='w-1/2'>
                <div>
                    <h3 className='text-sm text-gray-300 mb-0.5'>Task Titel</h3>
            ...
            <div className='w-2/5 flex flex-col items-start'>
                ...
                <textarea className='w-full h-44 text-sm py-2 px-4 rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4 ' name="" id="" cols='30' rows='10' placeholder='Desciption....' ></textarea>
